document.addEventListener("DOMContentLoaded", function () {
    ...
    window.fetchUserData = function () {
      ...
      fetch('http://localhost:8000/read/', {
        ...
        .then((data) => {
          if (data.length > 0) {
            if (document.getElementById('actualizarPersonaForm') || document.getElementById('borrarPersonaForm')) {
    ...
    function populateFormData(data) {
      ...
      document.getElementById('fechaNacimiento').value = data.birthDate.split('T')[0];
    ...
    function displayUserData(data) {
      ...
      document.getElementById('fechaNacimiento').innerText = data.birthDate.split('T')[0];
